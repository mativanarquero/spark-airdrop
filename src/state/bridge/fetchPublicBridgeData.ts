...
import { Bridge, Farm, SerializedBigNumber } from '../types'

type PublicBridgeData = {
  limit: SerializedBigNumber
}

const fetchPublicBridgeData = async (bridge: Bridge): Promise<PublicBridgeData> => {
  const { address, chainId } = bridge
...
export default fetchPublicBridgeData
