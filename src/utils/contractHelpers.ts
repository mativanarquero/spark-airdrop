...
export const getBridgeContract = (bridge: Bridge, web3?: Web3, useHomeAMB = false) => {
  const bridgeAbis = {
    ethToBsc: [
      {
        constant: false,
    ...
    homeAmb: [
      ...
      {
        constant: false,
        inputs: [{ name: '_tokenImage', type: 'address' }],
        name: 'setTokenImage',
        outputs: [],
        payable: false,
        stateMutability: 'nonpayable',
      ...
      {
        constant: true,
        inputs: [{ name: '_homeToken', type: 'address' }],
      ...
      {
        constant: true,
        inputs: [{ name: '_foreignToken', type: 'address' }],
      ...
      },
      {
        ...
        inputs: [
          ...
          { name: '_rewardAddresses', type: 'address[]' },
      ...
      },
      {
        ...
        inputs: [
          ...
          { indexed: false, name: 'lane', type: 'int256' },
        ],
  ...
  if (useHomeAMB) {
    return getContract(bridgeAbis.homeAmb, bridge.home, web3)
  }
